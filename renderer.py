...
def main():
   ...
   GREY = (128, 128, 128)
    ...
    pygame.display.set_caption("MineMindAI")

    # Import and initialise new object for the MineMind game
    # Set mine count to floor(width * height / 6) to get a decent difficulty
    # e.g. 16x16 board = 256 cells, 256 // 6 = 42 mines
    game = MineMind(BOARD_WIDTH, BOARD_HEIGHT,
    ...
    while True:
        ...
        text = heading.render("MINEMIND", True, WHITE)
        textRect = text.get_rect()
