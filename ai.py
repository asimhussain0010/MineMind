...
class Statement:
    """
    A logical statement about a condition in a MineMind game.
...
class AI:
    """
    AI implementation to play best moves for MineMind based on a knowledge base
    """
    ...
    def add_knowledge(self, cell, count, neighbours):
        """
        Called when the MineMind board tells us, for a given
    ...
    def make_safe_move(self):
        """
        Returns a safe cell to choose on the MineMind board, based on the knowledge base.
        """
    ...
    def make_random_move(self):
        """
        Returns a move to make on the MineMind board.
